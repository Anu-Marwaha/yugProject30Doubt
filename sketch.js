...
ground1 = new Ground(600,500,1200)
...
slingshot = new Slingshot(trigger.object,{x:90,y:150})
//trigger1 = new Trigger(90,250);
//console.log(trigger1.object.position);
...
function draw(){
   ...
   //trigger1.display();
   //trigger1.object.position.x=mouseX;
   //trigger1.object.position.y=mouseY;
  console.log(trigger.object.position);
